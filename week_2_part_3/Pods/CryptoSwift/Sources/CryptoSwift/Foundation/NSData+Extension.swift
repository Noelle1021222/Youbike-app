...
extension Data {
    ...
    public func encrypt(_ cipher: CipherProtocol) throws -> Data {
        let encrypted = try cipher.cipherEncrypt(self.arrayOfBytes())
        return Data.withBytes(encrypted)
    }

    public func decrypt(_ cipher: CipherProtocol) throws -> Data {
...
extension Data {
    ...
    class public func withBytes(_ bytes: [UInt8]) -> Data {
