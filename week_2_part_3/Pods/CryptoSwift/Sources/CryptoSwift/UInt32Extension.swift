...
extension UInt32 {
    ...
    public static func withBytes(_ bytes: ArraySlice<UInt8>) -> UInt32 {
        return UInt32.withBytes(Array(bytes))
    }

    /** Int with array bytes (little-endian) */
    public static func withBytes(_ bytes: [UInt8]) -> UInt32 {
...
extension UInt32 {
    ...
    fileprivate mutating func shiftLeft(_ count: UInt32) -> UInt32 {
        if (self == 0) {
            return self;
        }
    ...
    fileprivate mutating func shiftRight(_ count: UInt32) -> UInt32 {
        if (self == 0) {
            return self;
        }
